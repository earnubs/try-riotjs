...
},{"./tags/todo.tag":3,"riot":2}],2:[function(require,module,exports){
...
var riot = require('riot');
module.exports = riot.tag('todo', '<div each="{ opts.items }" onclick="{ parent.sayHi }"> <h3>{ title }</h3> </div>', 'todo, [riot-tag="todo"]{ display: block } todo h3, [riot-tag="todo"] h3{ font-size: 120% }', function(opts) {
